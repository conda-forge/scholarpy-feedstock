...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/scholarpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14755&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/scholarpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `scholarpy` can be installed with:

```
conda install scholarpy
```

It is possible to list all of the versions of `scholarpy` available on your platform with:
